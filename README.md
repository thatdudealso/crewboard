...
crewboard move CB-0001 active --as ux-agent
crewboard comment CB-0001 "Draft is ready for @captain" --as ux-agent
...
```text
.crewboard/
  board.json                 board name, columns, and monotonic counters
...
```sh
crewboard comment CB-0042 "@api-agent the contract changed. Can you verify the client?" \
  --as web-agent
