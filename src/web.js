...
refresh();setInterval(()=>{const editing=document.activeElement?.matches('input,textarea,select');const modalOpen=document.querySelector('#modal-backdrop').classList.contains('open');if(!editing&&!modalOpen)refresh();},5000);
</script></body></html>`;
}
